    ...
    public void show(List<Application> applicationList) {
        ...
        for (Application application : applicationList) {
            ...
            if (application.getInterviewDate() != null) {
                ...
                printField("Interview Date", application.getInterviewDate().toString());
                printField("Interview Time", application.getInterviewTime().toString());
                printField("Location", application.getInterviewLocation());

            }
            else if (application.getApplicationStatus() == ApplicationStatusEnum.SELECTED_FOR_INTERVIEW) {

                printField("Interview", "Not scheduled yet");
